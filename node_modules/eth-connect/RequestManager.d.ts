...
import { SHHFilterOptions, Data, Quantity, SHHFilterMessage, SHHPost, LogObject, TransactionReceipt, BlockObject, TransactionObject, TransactionCallOptions, TransactionOptions, Syncing, TxHash, Address, FilterOptions, Transaction, BlockIdentifier, FinishedTransactionAndReceipt, TransactionAndReceipt } from './Schema';
export declare let TRANSACTION_FETCH_DELAY: number;
export declare function inject(target: RequestManager, propertyKey: keyof typeof eth): void;
/**
 * @public

...
export declare function InvalidNumberOfSolidityArgs(given: number, expected: number): Error;
...
export declare function createError(message: string, code?: string, params?: any): Error;

 ...
 */
export function outputBigNumberFormatter(output) {
...
export function inputCallFormatter(options) {
    ...
    if (options.gasPrice !== undefined)
        options.gasPrice = utils.fromDecimal(options.gasPrice);
    if (options.gas !== undefined)
        options.gas = utils.fromDecimal(options.gas);
    if (options.value !== undefined)
        options.value = utils.fromDecimal(options.value);
    if (options.nonce !== undefined)
        options.nonce = utils.fromDecimal(options.nonce);
 ...
 */
export function inputTransactionId(txId) {
...
export function inputFilterOptions(options) {
    // TODO: validations
    return options;
}

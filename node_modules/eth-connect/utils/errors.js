...
export function InvalidNumberOfSolidityArgs(given, expected) {
    return new Error(`Invalid number of arguments to Solidity function. given: ${given}, expected: ${expected}`);
}
export function InvalidNumberOfRPCParams(methodName, given, expected) {
...
export function createError(message, code = UNKNOWN_ERROR, params = {}) {
    if (_censorErrors) {

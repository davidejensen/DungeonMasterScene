 ...
 * @public
 */
export declare type IAdapterHandler<Context, ReturnType> = (context: Context) => Promise<ReturnType>;
/**
 * Base interface to normalize adapters that accept middlewares
 * @public
 */
export declare type IMiddlewareAdapterHandler<Context, ReturnType> = (context: Context, next: () => Promise<ReturnType>) => Promise<ReturnType>;

 ...
 * @public
 */
export declare type ITracerComponent = {
    /**
 ...
 * @public
 */
export declare type TraceContext<T = any> = {
 ...
 * @public
 */
export declare type Trace = Pick<TraceContext, "traceId" | "version" | "parentId" | "traceFlags">;
/**
 * @public
 */
export declare type TraceState = Required<Pick<TraceContext, "traceState">>["traceState"];

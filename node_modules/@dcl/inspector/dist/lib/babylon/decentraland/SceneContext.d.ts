...
import { Entity, Transport } from '@dcl/ecs';
...
export declare class SceneContext {
    ...
    operations: {
        ...
        addChild: (parent: Entity, label: string) => void;
    ...
    constructor(babylon: BABYLON.Engine, scene: BABYLON.Scene, loadableScene: LoadableScene, dataLayer: DataLayerRpcClient);
    addTransport(stream: AsyncQueue<CrdtStreamMessage>): Transport;
    ...
    dispose(): void;
    connectCrdtTransport(crdtStream: DataLayerRpcClient['crdtStream']): Promise<void>;
}

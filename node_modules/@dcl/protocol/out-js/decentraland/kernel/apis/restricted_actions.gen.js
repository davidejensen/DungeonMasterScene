...
(function (TeleportToRequest) {
    function encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.worldPosition !== undefined) {
            vectors_gen_1.Vector3.encode(message.worldPosition, writer.uint32(10).fork()).ldelim();
        }
        if (message.cameraTarget !== undefined) {
            vectors_gen_1.Vector3.encode(message.cameraTarget, writer.uint32(18).fork()).ldelim();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    ...
                    message.worldPosition = vectors_gen_1.Vector3.decode(reader, reader.uint32());
                    continue;
                case 2:
                    if (tag !== 18) {
                        break;
    ...
    function fromJSON(object) {
        return {
            worldPosition: isSet(object.worldPosition) ? vectors_gen_1.Vector3.fromJSON(object.worldPosition) : undefined,
            cameraTarget: isSet(object.cameraTarget) ? vectors_gen_1.Vector3.fromJSON(object.cameraTarget) : undefined,
        };
    }
    ...
    function toJSON(message) {
        ...
        message.worldPosition !== undefined &&
            (obj.worldPosition = message.worldPosition ? vectors_gen_1.Vector3.toJSON(message.worldPosition) : undefined);
        message.cameraTarget !== undefined &&
            (obj.cameraTarget = message.cameraTarget ? vectors_gen_1.Vector3.toJSON(message.cameraTarget) : undefined);
        return obj;
    }
    ...
    function fromPartial(object) {
        ...
        message.worldPosition = (object.worldPosition !== undefined && object.worldPosition !== null)
            ? vectors_gen_1.Vector3.fromPartial(object.worldPosition)
            : undefined;
        message.cameraTarget = (object.cameraTarget !== undefined && object.cameraTarget !== null)
            ? vectors_gen_1.Vector3.fromPartial(object.cameraTarget)
            : undefined;
